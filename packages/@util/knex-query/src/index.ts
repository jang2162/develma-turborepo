...
export function queryBuilder<PARAM_TYPE = undefined, RESULT_TYPE = any>(
    ...
    return (
        ...
        params?: PARAM_TYPE,
    ): Knex.QueryBuilder<any, RESULT_TYPE[]> => {
